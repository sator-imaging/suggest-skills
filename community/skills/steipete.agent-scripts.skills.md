...
| [clawsweeper-status](https://github.com/steipete/agent-scripts/tree/main/skills/clawsweeper-status) | ClawSweeper status: URLs, workflow health, active workers, ops snapshot. | `agents/openai.yaml`, `scripts/clawsweeper-status.sh`, `scripts/clawsweeper-status.test.sh` |
| [clickclack](https://github.com/steipete/agent-scripts/tree/main/skills/clickclack) | ClickClack ops: chat app, Cloudflare Workers deploy, DNS/docs/app, container rollout. | `agents/openai.yaml` |
...
| [codex-first](https://github.com/steipete/agent-scripts/tree/main/skills/codex-first) | Route implementation work to Codex CLI; Claude specs, reviews, verifies. | None |
...
| [maintainer-orchestrator](https://github.com/steipete/agent-scripts/tree/main/skills/maintainer-orchestrator) | Open-source maintainer orchestration: Codex app workers, work recovery, dependencies, vision, releases. | `agents/openai.yaml`, `references/non-majority-repositories.md` |
...
| [npm](https://github.com/steipete/agent-scripts/tree/main/skills/npm) | npm registry ops: login, whoami, names, publish; 1Password tmux. | `scripts` (9 files) |
...
| [remote-mac](https://github.com/steipete/agent-scripts/tree/main/skills/remote-mac) | Remote Macs: MacBook, Mac Studio, clawmac, megaclaw, Tailscale, SSH, OpenClaw. | None |

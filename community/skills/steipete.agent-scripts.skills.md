...
| [maintainer-orchestrator](https://github.com/steipete/agent-scripts/tree/main/skills/maintainer-orchestrator) | Open-source maintainer orchestration: repo workers, work recovery, dependencies, vision, releases. | `agents/openai.yaml`, `references/non-majority-repositories.md` |

...
| [maintainer-orchestrator](https://github.com/steipete/agent-scripts/tree/main/skills/maintainer-orchestrator) | Orchestrate delegated maintainer work across Peter-majority repositories: prepare decision-ready PRs, monitor workers, clear queues, and release. | `agents/openai.yaml` |
